 ...
 * </p>
 * <ul>
 *   <li>{@link decisionDashboardMetaModel.impl.EncodingImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EncodingImpl extends MinimalEObjectImpl.Container implements Encoding {
	...
	protected EClass eStaticClass() {
		return DecisionDashboardMetaModelPackage.Literals.ENCODING;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DecisionDashboardMetaModelPackage.ENCODING__ID, oldId,
					id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case DecisionDashboardMetaModelPackage.ENCODING__ID:
			return getId();
		}
