 ...
 * </p>
 * <ul>
 *   <li>{@link decisionDashboardMetaModel.impl.DashboardImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link decisionDashboardMetaModel.impl.DashboardImpl#getVisualization <em>Visualization</em>}</li>
 *   <li>{@link decisionDashboardMetaModel.impl.DashboardImpl#getDecisionarea <em>Decisionarea</em>}</li>
 *   <li>{@link decisionDashboardMetaModel.impl.DashboardImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DashboardImpl extends MinimalEObjectImpl.Container implements Dashboard {
	...
	/**
	 * The cached value of the '{@link #getDecisionarea() <em>Decisionarea</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDecisionarea()
	 * @generated
	...
	protected EClass eStaticClass() {
		return DecisionDashboardMetaModelPackage.Literals.DASHBOARD;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DecisionDashboardMetaModelPackage.DASHBOARD__TITLE,
					oldTitle, title));
	}
	...
	public EList<Visualization> getVisualization() {
		if (visualization == null) {
			visualization = new EObjectContainmentEList<Visualization>(Visualization.class, this,
					DecisionDashboardMetaModelPackage.DASHBOARD__VISUALIZATION);
		}
	...
	public EList<DecisionArea> getDecisionarea() {
		if (decisionarea == null) {
			decisionarea = new EObjectContainmentEList<DecisionArea>(DecisionArea.class, this,
					DecisionDashboardMetaModelPackage.DASHBOARD__DECISIONAREA);
		}
		return decisionarea;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DecisionDashboardMetaModelPackage.DASHBOARD__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case DecisionDashboardMetaModelPackage.DASHBOARD__VISUALIZATION:
			return ((InternalEList<?>) getVisualization()).basicRemove(otherEnd, msgs);
		case DecisionDashboardMetaModelPackage.DASHBOARD__DECISIONAREA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case DecisionDashboardMetaModelPackage.DASHBOARD__TITLE:
			return getTitle();
		case DecisionDashboardMetaModelPackage.DASHBOARD__VISUALIZATION:
			return getVisualization();
		case DecisionDashboardMetaModelPackage.DASHBOARD__DECISIONAREA:
			return getDecisionarea();
		case DecisionDashboardMetaModelPackage.DASHBOARD__DESCRIPTION:
